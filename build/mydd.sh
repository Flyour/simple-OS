...
gcc -I ../lib/kernel/ -I ../lib/ -c -o timer.o ../device/timer.c -m32
...
gcc -I ../lib/kernel/ -I ../lib/ -I ../kernel/ -I ../device/ -c -fno-builtin -o init.o ../kernel/init.c -m32

ld -Ttext 0xc0001500 -e main -o kernel.bin main.o timer.o  init.o interrupt.o print.o kernel.o -m elf_i386
